...
export default function Cart() {
  ...
  const { total, savings } = getTotalPrice();
          ...
          {cart.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full">
              ...
              <p className="text-gray-600 mb-8">Add items to it now</p>
                ...
                <Link href="/">
                  <button className="bg-[#2874f0] hover:bg-blue-600 text-white font-medium py-2 px-16 rounded-sm transition-colors duration-300">
                    Shop now
                  </button>
                </Link>
            ...
            <div className="lg:flex lg:space-x-6">
              ...
              <div className="lg:w-1/3">
                <div className="bg-white rounded-lg shadow-md p-4 mb-4">
                  <PriceDetails priceDetails={{ total, savings }} />
                </div>
                <div className="bg-white rounded-lg shadow-md p-4">
                  <button
                    onClick={proceedToCheckout}
                    className=" w-full bg-[#fb641b] hover:bg-orange-600 text-white font-medium py-3 px-4 rounded-sm transition-colors duration-300">
                    Proceed to Checkout
                  </button>
                </div>
              </div>

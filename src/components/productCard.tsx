...
export default function ProductCard({ name, imageSrc, price }: ProductCardProps) {
    const { addToCart } = useCart();

  

    return (
        <div className="max-w-xs w-full rounded-xl shadow-lg overflow-hidden transition-transform duration-300 hover:scale-105">
            <div className="p-4">
                ...
                <button
                    onClick={() => addToCart(name, imageSrc, price)}
